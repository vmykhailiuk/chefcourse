...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chefcourse1-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/chefcompany"
  #   chef.validation_client_name = "chefcompany-validator"
  #   chef.validation_key_path = ".chef/chefcompany-validator.pem"
  # end
end
